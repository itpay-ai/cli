...
import { appendFeedbackPostmortemInstruction, type CommandAction, type CommandEnvelope, writeCommandEnvelope } from "./guidance.js";
...
function orderEnvelope(
  ...
  if (lockedRefund) {
    ...
    instruction = appendFeedbackPostmortemInstruction(
